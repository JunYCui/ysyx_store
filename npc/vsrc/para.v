// __Type__
`define R_Type_ysyx_24100029 3'd1
`define I_Type_ysyx_24100029 3'd2
`define S_Type_ysyx_24100029 3'd3
`define B_Type_ysyx_24100029 3'd4
`define U_Type_ysyx_24100029 3'd5
`define J_Type_ysyx_24100029 3'd6
