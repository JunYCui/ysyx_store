...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", mul    , RE, R(rd) = (int32_t)src1 * src2);
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , RE, res=(int64_t)(int32_t)src1*(int64_t)(int32_t)src2;  printf("%d, %ld",(int32_t)src2, res));
