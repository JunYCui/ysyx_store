...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 100 ????? 00000 11", lbu    , I, R(rd) = Mr(((int)src1 + imm), 1));
  ...
  INSTPAT("??????? ????? ????? 010 ????? 01000 11", sw     , S, Mw(((int)src1 + imm), 4, src2));
  INSTPAT("??????? ????? ????? 000 ????? 01000 11", sb     , S, Mw(((int)src1 + imm), 1, src2));
  INSTPAT("??????? ????? ????? 001 ????? 01000 11", sh     , S, Mw(((int)src1 + imm), 2, src2));
