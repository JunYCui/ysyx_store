...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 01100 11", sll    , RE, R(rd) = src1 << (src2%32)); // shift left logical 
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 01100 11", sra    , RE, R(rd) = (int32_t)src1 >> (src2%32)); 
  INSTPAT("0000000 ????? ????? 101 ????? 01100 11", srl    , RE, R(rd) = ((uint32_t)src1 >>(src2%32))); 
